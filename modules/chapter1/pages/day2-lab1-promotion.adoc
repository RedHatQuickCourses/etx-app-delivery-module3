...
Edit the configuration section with your cluster credentials (from RHDP emails), substitute RUNTIME-GUID/FACTORY-GUID, {RUNTIME/FACTORY_cluster_admin_password} with your lab GUID and lab password :
...
[source,bash,role=execute]
----
oc login -u <RUNTIME_USERNAME> -p <RUNTIME_PASSWORD> <RUNTIME_API_URL> --insecure-skip-tls-verify
----
