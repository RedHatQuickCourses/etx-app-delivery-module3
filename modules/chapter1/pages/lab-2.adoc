...
:navtitle: Lab 2: Deploy Supporting Services
...
NOTE: `verbosity: detailed` prints full trace details to stdout (visible in collector pod logs). The `logging` exporter was removed in Collector v0.111+; use `debug` instead.
