...
You should see your PipelineRun with status `Running` and once complete it should be `Succeeded`.
...
+
image::gitlab_signin.png[width=450]  
+
* *Username:* `root`
...
. Scroll down the page and notice the *Outbound requests* section, expand the section.
...
. Navigate to the project, for this select *Admin area* → *Dashboard* → select *etx_app_base_app*
+  
image::admin_area.png[width=500]
+  
. Go to menu:System hooks
+
image::hook.png[width=300]
+
...
. Test the webhook:
* Find your webhook in the **System hooks** list
* Click btn:[Test] → *Push events*

image::push.png[width=600]

* You should see "Hook executed successfully: HTTP 202" or similar
+
image::status.png[width=700]
...
Navigate to your devspaces **etx-app-base-app** workspaces and push a change to your repository and confirm the pipeline triggers:
